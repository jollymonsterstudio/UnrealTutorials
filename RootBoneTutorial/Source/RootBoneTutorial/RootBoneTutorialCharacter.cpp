...
//////////////////////////////////////////////////////////////////////////
// ARootBoneTutorialCharacter

ARootBoneTutorialCharacter::ARootBoneTutorialCharacter()
{
...
void ARootBoneTutorialCharacter::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &ARootBoneTutorialCharacter::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &ARootBoneTutorialCharacter::OnAttackHit);
...
void ARootBoneTutorialCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ARootBoneTutorialCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ARootBoneTutorialCharacter::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ARootBoneTutorialCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ARootBoneTutorialCharacter::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ARootBoneTutorialCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ARootBoneTutorialCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARootBoneTutorialCharacter::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &ARootBoneTutorialCharacter::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &ARootBoneTutorialCharacter::KickAttack);
	
}

void ARootBoneTutorialCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ARootBoneTutorialCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void ARootBoneTutorialCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void ARootBoneTutorialCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ARootBoneTutorialCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void ARootBoneTutorialCharacter::MoveForward(float Value)
{
...
void ARootBoneTutorialCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool ARootBoneTutorialCharacter::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void ARootBoneTutorialCharacter::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType ARootBoneTutorialCharacter::GetCurrentAttack()
{
	return CurrentAttack;
}

void ARootBoneTutorialCharacter::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void ARootBoneTutorialCharacter::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void ARootBoneTutorialCharacter::AttackInput(EAttackType AttackType)
{
...
void ARootBoneTutorialCharacter::AttackStart()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void ARootBoneTutorialCharacter::AttackEnd()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void ARootBoneTutorialCharacter::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void ARootBoneTutorialCharacter::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void ARootBoneTutorialCharacter::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
